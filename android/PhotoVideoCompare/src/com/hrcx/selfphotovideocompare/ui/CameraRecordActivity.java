...
@TargetApi(9)
public class CameraRecordActivity extends BasicActivity implements Callback,
		SensorEventListener {
	...
	class VerificationPassTask extends AsyncTask<String, Boolean, Boolean> {
		...
		protected Boolean doInBackground(String... params) {
			return new NetProtocol(CameraRecordActivity.this).selfSaveVideo();
		}
		...
		protected void onPostExecute(Boolean result) {
			...
			Intent intent = new Intent(CameraRecordActivity.this,
					SelfMainActivity.class);
			Constant.loginState=2;
