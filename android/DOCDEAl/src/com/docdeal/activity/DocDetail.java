 ...
 * 
 */
public class DocDetail extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TitleBar.title="公文详细";
		ActivityUtil.getInstance().initActivity(this,R.layout.docdetail_main);
	...
	private void initView() {
		...
		adapter = new DocDetailAdapter(this, LayoutInflater.from(this),
				nodeList, dm, dealMap, docId);
		proDialog = ProgressDialog.show(DocDetail.this, "请稍后", "数据访问中", true,
				true);
	...
	public void onClick(View v) {
		...
		case R.id.btn_submit:
			intent = new Intent(DocDetail.this, DocDeal.class);
			this.getDealXml();
	...
	private String getDocInput() {
		...
		try {
			...
			// Intent intent = OpenFileUtil.openFile(this,sss);
