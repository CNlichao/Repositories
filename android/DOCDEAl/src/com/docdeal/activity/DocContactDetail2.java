...
public class DocContactDetail2 extends Activity {
	private TextView phone;
	private TextView housePhone;
	private TextView name;
	private TextView job;
	private TextView outsidePhone;
	private TextView cornet;
	private Button bt1;
	private Button bt2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ActivityUtil.getInstance()
				.initActivity(this, R.layout.doccontactdetail2);
		...
		housePhone = (TextView) findViewById(R.id.DoccontactDetailHousePhone);
		name = (TextView) findViewById(R.id.DoccontactDetailName);
		job = (TextView) findViewById(R.id.DoccontactDetailJob);
		outsidePhone = (TextView) findViewById(R.id.DoccontactDetailOutsidePhone);
		cornet = (TextView) findViewById(R.id.DoccontactCornet);

		
		phone.setText(cu.getPhone());
		housePhone.setText(cu.getHousePhone());
		name.setText(cu.getName());
		job.setText(cu.getJob());
		outsidePhone.setText(cu.getOutsidePhone());
		cornet.setText(cu.getCornet());
	...
	public void dial(TextView tv) {
		...
		if (phone_number != null && !phone_number.equals("")) {
			...
			Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:"
					+ phone_number));
			DocContactDetail2.this.startActivity(intent);// 内部类
		}
	}
