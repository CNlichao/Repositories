 ...
 * 
 */
public class RecieveDocDetail extends Activity implements OnClickListener {

	public static String DocmentDetail = "DOCUMENTDETAIL";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TitleBar.title="公文处理";
		ActivityUtil.getInstance().initActivity(this,R.layout.recieve_doc_detail);
		initView();
		initData();
		// setViewData();
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_submit:
			intent = new Intent(RecieveDocDetail.this, DocDeal.class);
